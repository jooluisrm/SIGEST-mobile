...
type Props = {
    ...
    periodoLetivoName: string;
    status: boolean | number;
    onPress: () => void;
};

export const OfertaDisciplinaCard = ({ 
    disciplineName, 
    classroomName, 
    professorName, 
    periodoLetivoName, 
        ...
        >
            <View style={styles.infoSection}>
                ...
                <View style={styles.detailRow}>
                    <Ionicons name="people-outline" size={14} color="#52B28B" style={styles.icon} />
                ...
                {/* Professor Row */}
                <View style={styles.detailRow}>
                    <Ionicons name="person-outline" size={14} color="#52B28B" style={styles.icon} />
                    <Text style={styles.detailText} numberOfLines={1} ellipsizeMode="tail">
                        Prof: {professorName}
                    </Text>
                </View>
                ...
                <View style={styles.detailRow}>
                    ...
                    <Text style={styles.metaText} numberOfLines={1} ellipsizeMode="tail">
                        Período Letivo: {periodoLetivoName}
                    </Text>
                </View>
            </View>
